...
user_ratings_user_counts = user_ratings_user_counts[user_ratings_user_counts['count'] > 10]
...
user_ratings_tconst_counts = user_ratings_tconst_counts[user_ratings_tconst_counts['count'] > 3]
...
# 保存过滤后的数据
# filtered_movies.to_csv("./data_out/small_dataset_filtered_high_quality_movies_s.csv", index=False)
# filtered_cast.to_csv("./data_out/small_dataset_filtered_high_quality_cast.csv", index=False)
# filtered_user_ratings.to_csv("./data_out/small_dataset_filtered_high_quality_user_ratings.csv", index=False)
# filtered_directors.to_csv("./data_out/small_dataset_filtered_high_quality_directors.csv", index=False)
# filtered_genres.to_csv("./data_out/small_dataset_filtered_high_quality_genres.csv", index=False)
# filtered_grades.to_csv("./data_out/small_dataset_filtered_high_quality_grades.csv", index=False)
# filtered_directors.to_csv("./data_out/small_dataset_filtered_high_quality_directors.csv", index=False)
